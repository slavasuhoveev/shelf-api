...
@album_work_router.patch("/{album_id}",
                         response_model=record_schemas.AlbumWorkRead,
...
@release_router.patch("/{release_id}",
                      response_model=record_schemas.ReleaseRead,
                      response_model_exclude_unset=True)
